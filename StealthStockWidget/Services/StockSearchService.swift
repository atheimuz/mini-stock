...
final class StockSearchService {
    ...
    private static var resourceBundle: Bundle {
        // 1. SPM development build: Bundle.module (generated by SPM)
        // 2. .app bundle: Contents/Resources/StealthStockWidget_StealthStockWidget.bundle
        if let resourceURL = Bundle.main.resourceURL?
            .appendingPathComponent("StealthStockWidget_StealthStockWidget.bundle"),
    ...
    private func loadCSV() {
        guard let url = Self.resourceBundle.url(forResource: "krx_stocks", withExtension: "csv"),
